...
- Monthly PDF exports include the GPS proxy limitation alongside Safety and Smoothness results; heading events and Heading Drift Beta are shown only when advanced detection was enabled for the rescored trip.
