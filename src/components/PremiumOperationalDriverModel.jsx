...
import premiumOperationalHero from '@/assets/premium-operational-model-hero-v1.webp';
import premiumOperationalStrength from '@/assets/premium-operational-model-strength-v1.webp';
import premiumOperationalBraking from '@/assets/premium-operational-model-braking-v1.webp';
import premiumOperationalFatigue from '@/assets/premium-operational-model-fatigue-v1.webp';
import premiumIconBrain from '@/assets/premium-operational-icon-brain-v1.webp';
import premiumIconAggression from '@/assets/premium-operational-icon-aggression-v1.webp';
import premiumIconSmoothness from '@/assets/premium-operational-icon-smoothness-v1.webp';
import premiumIconSpeed from '@/assets/premium-operational-icon-speed-v1.webp';
import premiumIconConsistency from '@/assets/premium-operational-icon-consistency-v1.webp';
import premiumIconBraking from '@/assets/premium-operational-icon-braking-v1.webp';
import premiumIconFatigue from '@/assets/premium-operational-icon-fatigue-v1.webp';
import premiumIconAcceleration from '@/assets/premium-operational-icon-acceleration-v1.webp';
import premiumIconTurns from '@/assets/premium-operational-icon-turns-v1.webp';
import premiumIconSpeeding from '@/assets/premium-operational-icon-speeding-v1.webp';
import premiumIconPhone from '@/assets/premium-operational-icon-phone-v1.webp';
