...
describe('PremiumSegmentIntelligenceCard', () => {
  ...
  it('renders real route controls, evidence values, and distinct generated artwork', () => {
    ...
    expect(html).toContain('premium-segment-icon-network-v1.png');
    expect(html).toContain('premium-segment-icon-arrow-v1.png');
    expect(html).toContain('premium-segment-icon-evening-v1.png');
    expect(html).toContain('premium-segment-icon-morning-v1.png');
    expect(html).toContain('premium-segment-icon-repeat-v1.png');
    expect(html).toContain('premium-segment-icon-car-v1.png');
    expect(html).toContain('premium-segment-icon-target-v1.png');
    expect(html).toContain('premium-segment-icon-shield-v1.png');
    expect(html).toContain('premium-segment-icon-midday-v1.png');
    expect(html).toContain('premium-segment-icon-pin-v1.png');
