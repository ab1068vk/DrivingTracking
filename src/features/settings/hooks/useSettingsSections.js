...
export const SETTINGS_SECTIONS = [
  ...
  { label: 'Privacy and backup', section: 'Privacy & Data', sectionId: 'settings-privacy-data', detail: 'Backup, import, export, saved filters, and feedback data.', keywords: 'privacy export import backup retention delete data saved filters event feedback' },
];
