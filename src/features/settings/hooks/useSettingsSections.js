...
export const SETTINGS_SECTIONS = [
  ...
  { label: 'Location permission', section: 'Android Permissions', sectionId: 'settings-android-permissions', detail: 'Request foreground and background location for manual and automatic tracking.', keywords: 'gps precise location foreground background allow all the time permission prompt denied granted' },
  { label: 'Activity and notification permissions', section: 'Android Permissions', sectionId: 'settings-android-permissions', detail: 'Physical activity, notifications, battery optimization, and usage access setup.', keywords: 'activity recognition physical motion notification battery unrestricted usage access android permission prompt' },
  ...
  { label: 'Voice alerts', section: 'Voice Alerts', sectionId: 'settings-voice-alerts', detail: 'Speech rate, volume, earcon tones, minimum severity, and quiet hours for spoken alerts.', keywords: 'voice speech spoken tts rate volume earcon tone quiet hours severity critical warning alert hearing road noise' },
  ...
  { label: 'Detection thresholds', section: 'Detection Features', sectionId: 'settings-detection-thresholds', detail: 'Detection toggles, thresholds, sensitivity, calibration, re-score, and event feedback behavior.', keywords: 'threshold thresholds harsh braking rapid acceleration speeding idle lane changing brake turn heading drift calibration rescore feedback accurate wrong false positive' },
  { label: 'Coaching Calibration', section: 'Advanced Models', sectionId: 'settings-calibration', detail: 'Calibration progress, model status, sharing, label balance, milestones, and recent unrated trips.', keywords: 'calibration labels survey completion rate rated unlabeled recent trips feedback provisional scoring model sharing' },
  { label: 'Advanced models', section: 'Advanced Models', sectionId: 'settings-advanced-models', detail: 'Weather, OSRM, historical context risk, OBD, sensor fusion, and crash signals.', keywords: 'weather osrm route risk obd bluetooth sensor fusion crash map line event marker cornering heatmap' },
  ...
  { label: 'App lock', section: 'Privacy & Data', sectionId: 'settings-privacy-data', detail: 'Optional device credential lock and inactivity timeout.', keywords: 'biometric fingerprint device credential app lock auto-lock timeout unlock optional privacy' },
  { label: 'Stealth Trip Mode', section: 'Privacy & Data', sectionId: 'settings-privacy-data', detail: 'Record the next trip in memory only and erase route points when it ends.', keywords: 'stealth private ephemeral next trip memory erase route points events no saved record' },
];
