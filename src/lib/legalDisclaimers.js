...
export const LEGAL_DISCLAIMER_SUMMARY =
  `${LEGAL_DISCLAIMER_SHORT} Road Sage estimates driving patterns from device sensors, GPS, maps, weather, route, vehicle, cost, emissions, and optional third-party data that can be incomplete, delayed, unavailable, or wrong. You remain responsible for safe driving, posted signs, traffic laws, road conditions, vehicle condition, data sharing, and any decision made from app outputs.`;

export const LEGAL_NOTICE_ACK_VERSION = 1;

export const LEGAL_NOTICE_INTRO =
  'Road Sage is a local-first driving log and coaching app. Read this before using tracking, scores, maps, alerts, exports, backups, or survey features.';
...
export const LEGAL_DISCLAIMER_ITEMS = [
  ...
  },
  {
    ...
    body: 'Safety, smoothness, eco, UBI-style, fatigue, focus, phone-use, speed, braking, acceleration, cornering, lane-change, route-risk, historical-context, maintenance, tire, fuel, EV, emissions, and cost outputs are estimates and can be inaccurate, incomplete, delayed, or unavailable.',
  },
  {
  ...
  },
  {
    ...
    body: 'Trip, GPS, route, score, vehicle, settings, survey label, backup, export, notification, and diagnostic data are stored locally by default. Anyone with device access, exported files, readable backups, or imported data may be able to view sensitive trip or location details.',
  },
  {
    title: 'Optional external requests',
    body: 'Optional road, weather, and route-matching features can send limited route-area boxes to OpenStreetMap, a privacy-safe route point and date to Open-Meteo, or sampled GPS coordinate pairs to the OSRM endpoint you configure and explicitly approve. Review those services before enabling or relying on them.',
  },
  {
  ...
  },
  {
    ...
    body: 'Location, motion/activity, notification, sensor, Bluetooth, and background tracking permissions can collect or display sensitive information. Turn off tracking modes, notifications, or permissions if they do not fit your privacy, battery, workplace, family, or legal requirements.',
  },
  {
