...
import {
  ...
  buildLocalFeatureTestTrips,
  LOCAL_TEST_TRIP_PREFIX,
} from '@/lib/localTestTrips';
...
describe('local feature test trips', () => {
  ...
  it('blocks synthetic trip seeding outside development builds', () => {
    expect(() => assertLocalFeatureTestTripsAllowed({ DEV: false })).toThrow(/development builds/);
  });
});
