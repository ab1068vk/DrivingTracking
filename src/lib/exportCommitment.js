...
export function commitZoneForExportSync(zone = {}, exportId = createExportId()) {
  ...
  const hashBytes = sha256Bytes(material);
...
export async function commitZoneForExport(zone = {}, exportId = createExportId()) {
  return commitZoneForExportSync(zone, exportId);
}
