...
export async function buildOpenSourceTripContextPatch(trip, settings = localSettings.get(), options = {}) {
  ...
  return {
    ...
    map_matching_context: {
      ...
      low_confidence_points: mapMatchingContext.low_confidence_points ?? 0,
      tracepoint_count: mapMatchingContext.tracepoint_count ?? 0,
      gap_count: mapMatchingContext.gap_count ?? 0,
      route_geometry: mapMatchingContext.route_geometry || [],
      road_segments: mapMatchingContext.road_segments || [],
