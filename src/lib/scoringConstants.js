...
export const SCORING_CONSTANTS = Object.freeze({
  ...
  ECO_SPEED_STABILITY_CV_MULTIPLIER: constant(150, { label: 'Eco speed stability multiplier', domain: 'trip_score', calibration_note: 'Converts moving-speed variation to a diagnostic eco score.', affected_metrics: ['score_eco'] }),
  FUEL_BAND_FULL_SCORE_MULTIPLIER: constant(1.1, { label: 'Fuel band score multiplier', domain: 'trip_score', calibration_note: 'Rewards sustained efficient cruising.', affected_metrics: ['score_eco'] }),
  ...
  OVERALL_SCORE_BLEND_WEIGHTS: constant(Object.freeze({ safety: 0.55, smoothness: 0.30, eco: 0, intersection: 0.15 }), { label: 'Overall score blend weights', domain: 'trip_score', calibration_note: 'Composite driving score weighting policy. Eco remains a separate component score and is not blended into the headline trip score.', affected_metrics: ['score_overall'] }),
  ...
  ECO_SCORE_BLEND_WEIGHTS: constant(Object.freeze({ base: 0.40, ecoDriving: 0.40, fuelBand: 0.20 }), { label: 'Eco score blend weights', domain: 'trip_score', calibration_note: 'Composite Eco weighting policy. Eco is displayed separately from the headline trip score.', affected_metrics: ['score_eco'] }),
  ...
  ECO_CRUISE_MIN_KMH: constant(55, { label: 'Eco cruise minimum', domain: 'trip_threshold', calibration_note: 'Efficient-cruise band assumption.', affected_metrics: ['score_eco'], setting_key: 'threshold_eco_cruise_min_kmh' }),
  ECO_CRUISE_MAX_KMH: constant(110, { label: 'Eco cruise maximum', domain: 'trip_threshold', calibration_note: 'Efficient-cruise band assumption.', affected_metrics: ['score_eco'], setting_key: 'threshold_eco_cruise_max_kmh' }),
  ECO_CRUISE_SCORE_MULTIPLIER: constant(130, { label: 'Eco cruise score multiplier', domain: 'trip_threshold', calibration_note: 'Full credit near 77 percent cruising samples.', affected_metrics: ['score_eco'], setting_key: 'eco_cruise_score_multiplier' }),
  ECO_IDLE_PENALTY_MULTIPLIER: constant(150, { label: 'Eco idle penalty multiplier', domain: 'trip_threshold', calibration_note: 'Avoidable-idle score curve.', affected_metrics: ['score_eco'], setting_key: 'eco_idle_penalty_multiplier' }),
  ECO_IDLE_MAX_PENALTY: constant(25, { label: 'Eco idle penalty cap', domain: 'trip_threshold', calibration_note: 'Maximum score deduction from avoidable idle.', affected_metrics: ['score_eco'], setting_key: 'eco_idle_max_penalty' }),
  ECO_MIN_MOVING_KMH: constant(15, { label: 'Eco moving speed floor', domain: 'trip_threshold', calibration_note: 'Suppresses crawl and GPS jitter samples.', affected_metrics: ['score_eco'], setting_key: 'eco_min_moving_kmh' }),
  IDLE_SPEED_KMH: constant(5, { label: 'Idle speed floor', domain: 'trip_threshold', calibration_note: 'Speed below which a GPS sample is considered idle.', affected_metrics: ['score_eco'] }),
  IDLE_EVENT_SECONDS: constant(90, { label: 'Idle event duration', domain: 'trip_threshold', calibration_note: 'Minimum sustained idle duration.', affected_metrics: ['score_eco'], setting_key: 'threshold_idle_seconds' }),
