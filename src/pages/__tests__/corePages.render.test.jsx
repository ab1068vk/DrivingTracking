...
describe('core page component renders', () => {
  ...
  it('gates the premium Coaching cards behind the persisted appearance setting', async () => {
    ...
    expect(premiumShiftHtml).toContain('premium-recent-shift-route-layer.webp');
    expect(premiumShiftHtml).toContain('premium-recent-shift-car-layer.webp');
    expect(premiumShiftHtml).toContain('premium-recent-shift-shield.webp');
    expect(premiumHtml).toContain('premium-connected-goals-hero.webp');
    expect(premiumHtml).toContain('premium-connected-goals-atlas.webp');
  ...
  it('keeps Trip Detail standard while matching premium map route intelligence to the appearance setting', async () => {
    ...
    expect(mapHtml).toContain('premium-map-control-view.webp');
    expect(mapHtml).toContain('premium-map-control-playback.webp');
    expect(mapHtml).toContain('premium-map-control-layers.webp');
    ...
    expect(mapHtml).toContain('premium-map-trip-emblem-blue-v2.webp');
