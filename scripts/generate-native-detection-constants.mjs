...
const FIELDS = [
  ...
  },
  {
    ...
    fields: [
      { name: 'HAZARD_HORIZON_ALERT_SECONDS', type: 'double', value: HAZARD_HORIZON_ALERT_SECONDS, source: 'appConstants.HAZARD_HORIZON_ALERT_SECONDS' },
      { name: 'HAZARD_HORIZON_MIN_SECONDS', type: 'double', value: HAZARD_HORIZON_MIN_SECONDS, source: 'appConstants.HAZARD_HORIZON_MIN_SECONDS' },
      { name: 'HAZARD_HORIZON_MIN_SECONDS_SETTING', type: 'double', value: HAZARD_HORIZON_MIN_SECONDS_SETTING, source: 'appConstants.HAZARD_HORIZON_MIN_SECONDS_SETTING' },
      { name: 'HAZARD_HORIZON_MAX_SECONDS', type: 'double', value: HAZARD_HORIZON_MAX_SECONDS, source: 'appConstants.HAZARD_HORIZON_MAX_SECONDS' },
      { name: 'HAZARD_PROJECTION_SLACK', type: 'double', value: HAZARD_PROJECTION_SLACK, source: 'appConstants.HAZARD_PROJECTION_SLACK' },
      { name: 'HAZARD_PROJECTION_MIN_M', type: 'double', value: HAZARD_PROJECTION_MIN_M, source: 'appConstants.HAZARD_PROJECTION_MIN_M' },
      { name: 'HAZARD_PROJECTION_MAX_M', type: 'double', value: HAZARD_PROJECTION_MAX_M, source: 'appConstants.HAZARD_PROJECTION_MAX_M' },
      { name: 'HAZARD_FORWARD_CONE_DEG', type: 'double', value: HAZARD_FORWARD_CONE_DEG, source: 'appConstants.HAZARD_FORWARD_CONE_DEG' },
      { name: 'HAZARD_CORRIDOR_MAX_HALF_WIDTH_M', type: 'double', value: HAZARD_CORRIDOR_MAX_HALF_WIDTH_M, source: 'appConstants.HAZARD_CORRIDOR_MAX_HALF_WIDTH_M' },
      { name: 'HAZARD_MIN_SPEED_KMH', type: 'double', value: HAZARD_MIN_SPEED_KMH, source: 'appConstants.HAZARD_MIN_SPEED_KMH' },
      { name: 'HAZARD_MAX_ACCURACY_M', type: 'float', value: HAZARD_MAX_ACCURACY_M, source: 'appConstants.HAZARD_MAX_ACCURACY_M' },
      { name: 'HAZARD_ALERT_GLOBAL_COOLDOWN_MS', type: 'long', value: HAZARD_ALERT_GLOBAL_COOLDOWN_MS, source: 'appConstants.HAZARD_ALERT_GLOBAL_COOLDOWN_MS' },
    ],
  },
];
