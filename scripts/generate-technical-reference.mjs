...
function buildDoc() {
  ...
  doc.push(table(
    ...
    [
      ...
      ['Primary storage', 'IndexedDB/localStorage/sessionStorage/Capacitor Preferences/Android SharedPreferences, Android widget cache files, native motion samples, and native download files.'],
...
function buildReadme() {
  ...
  return [
    ...
    '- Primary storage: IndexedDB, localStorage, sessionStorage, Capacitor Preferences, Android SharedPreferences, native motion samples on trips, native download files, and Android widget map cache files',
