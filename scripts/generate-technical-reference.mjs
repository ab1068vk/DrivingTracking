...
function buildReadme() {
  ...
  return [
    ...
    '- Reaction-time proxy scoring now requires at least three harsh-braking samples before reporting a score and can reach 0 instead of retaining the former 20-point floor. Insufficient evidence returns `reaction_score: null` and stays neutral in the smoothness composite.',
