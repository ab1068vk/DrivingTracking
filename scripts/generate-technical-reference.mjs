...
function buildReadme() {
  ...
  return [
    ...
    '- `node tests/android-uiautomator-full-app.mjs` targets a connected Android device: UIAutomator verifies the focused Road Sage WebView shell, Chrome DevTools Protocol verifies rendered React dashboard text inside the Capacitor WebView, and logcat is checked for app crashes or JavaScript exceptions.',
