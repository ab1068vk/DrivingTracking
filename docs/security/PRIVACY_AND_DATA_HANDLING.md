...
[DETECTION_PIPELINE.md](../architecture/DETECTION_PIPELINE.md) §5). Motion samples were already personal
...
budgets in [CAPTURE_FIDELITY.md](../architecture/CAPTURE_FIDELITY.md). What changed is that a stored score
