> **Currency note.** This document dates from June 2026 and predates later storage, query and
> road-knowledge work. It remains useful as a detailed walkthrough of the speed pipeline, voice
> alerts and OpenStreetMap lookup behaviour. Where it disagrees with
> [ROAD_SPEED_KNOWLEDGE.md](ROAD_SPEED_KNOWLEDGE.md) or the current source, the current
> architecture document and the source are authoritative.
