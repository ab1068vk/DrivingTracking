...
Companion documents: [PRIVACY_INTELLIGENCE.md](../security/PRIVACY_AND_DATA_HANDLING.md) for what the motion
stream implies for personal data, [CAPTURE_FIDELITY.md](CAPTURE_FIDELITY.md) for how those
samples are captured and budgeted, and [the generated technical reference](../README.md#generated-reference) for
