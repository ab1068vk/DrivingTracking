...
- [UI and loading performance guide](UI_LOADING_PERFORMANCE.md): detailed app-wide loading audit, Saved road speeds lag analysis, UI loading rules, and implementation snippets.
