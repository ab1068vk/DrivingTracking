> **Historical record.** This is the June 2026 UI lag incident playbook and implementation
> plan. Its measurements, incident triage steps and handoff sections describe a past
> investigation; the bounded-query and deferred-work changes it proposed have since been
> implemented. It is **not** current performance documentation. See
> [docs/development/PERFORMANCE.md](../development/PERFORMANCE.md).
